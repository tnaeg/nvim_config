...
---@class RootPath
---@field paths string[]
---@field spec RootPathSpec

---@alias RootPathFn fun(buf: number): (string|string[])

---@alias RootPathSpec string|string[]|RootPathFn
...
---@param opts? { buf?: number, spec?: RootPathSpec[], all?: boolean }
function M.detect(opts)
	opts = opts or {}
	opts.spec = opts.spec or type(vim.g.root_spec) == "table" and vim.g.root_spec or M.spec
	opts.buf = (opts.buf == nil or opts.buf == 0) and vim.api.nvim_get_current_buf() or opts.buf

	local ret = {} ---@type RootPath[]
...
function M.info()
	...
	lines[#lines + 1] = "```"
	require("base.util").info(lines, { title = "Root Directories" })
...
function M.setup()
	vim.api.nvim_create_user_command("RootPath", function()
		Util.root.info()
	end, { desc = "Root paths for current buffer" })
...
function M.get(opts)
	...
	return false and ret:gsub("/", "\\") or ret
end
